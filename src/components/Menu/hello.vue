      ...
      <router-link :to="{name: 'Menu', params: { locId: locationId}}">
        ...
        <form @click.prevent>
            ...
            <div class="row g-3 align-items-center">
                <div class="col-auto d-block mx-auto">
                    <div class="form-floating mb-3" :class="{'form-group-error': v$.pickedCategory.$error}">
                        <input type="text" class=" w250" disabled id="floatItemName"  v-model.trim="itemsName">
            ...
            <div class="row g-3 align-items-center">
                <div class="col-auto d-block mx-auto">
                    <div class="form-floating mb-3" :class="{'form-group-error': v$.pickedCategory.$error}">
                        <input type="number" class=" w250" disabled id="floatItemPrice" v-model.trim="itemprice">
            ...
            <div class="row g-3 align-items-center">
                <div class="col-auto d-block mx-auto">
                    <div class="form-floating mb-3" :class="{'form-group-error': v$.pickedCategory.$error}">
                        <input type="number" class=" w250" id="floatItemQty" disabled  v-model.trim="itemsQty">
            ...
            <div class="row g-3 align-items-center">
                <div class="col-auto d-block mx-auto">
                    <div class="form-floating mb-3" :class="{'form-group-error': v$.pickedCategory.$error}">
                        <textarea class=" w250 h200" disabled  id="floatItemDescriptions" v-model.trim="descriptions"></textarea>
            ...
            <div class="row g-3 align-items-center">
                <div class="col-auto d-block mx-auto">
                    <div class="form-floating mb-3" :class="{'form-group-error': v$.pickedCategory.$error}">
                        <select class="w250 " disabled id="floatItemCategory" v-model.trim="pickedCategory">
